...
//       <p className='bg-[#49B9FF]/50 px-3.5 py-1 round-full mt-20'>The Ultimate Hotel Experience</p>
...
const Hero = () => {
  ...
  return (
    <div
      className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white h-screen transition-all duration-500 ease-in-out bg-black/20'
      style={{
